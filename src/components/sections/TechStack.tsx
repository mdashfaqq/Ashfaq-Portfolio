...
const techRows: TechRow[] = [
  ...
  {
    id: "row-2",
    label: "ROW 02 // BACKEND, MOBILE & DATABASE",
    direction: "right-to-left",
    speedSeconds: 36,
    items: [
      { name: "Node.js", icon: SiNodedotjs, color: "#5FA04E", isPrimary: true },
      { name: "FastAPI", icon: SiFastapi, color: "#009688", isPrimary: true },
      { name: "PostgreSQL", icon: SiPostgresql, color: "#4169E1", isPrimary: true },
      { name: "Flutter", icon: SiFlutter, color: "#02569B", isPrimary: true },
      { name: "Supabase", icon: SiSupabase, color: "#3ECF8E", isPrimary: true },
      { name: "MySQL", icon: SiMysql, color: "#4479A1", isPrimary: true },
      { name: "Express.js", icon: SiExpress, color: "#E5E7EB" },
      { name: "PHP", icon: SiPhp, color: "#777BB4" },
      { name: "REST APIs", icon: SiPostman, color: "#FF6C37", isPrimary: true },
      { name: "Capacitor", icon: SiCapacitor, color: "#119EFF" },
    ],
  },
  {
    id: "row-3",
    label: "ROW 03 // SECURITY, SYSTEMS & AI DEVELOPMENT",
    direction: "left-to-right",
    speedSeconds: 34,
    items: [
      ...
      { name: "GitHub", icon: SiGithub, color: "#F0F6FC", isPrimary: true },
      { name: "Nginx", icon: SiNginx, color: "#009639" },
      { name: "OWASP", icon: SiOwasp, color: "#FFFFFF", isPrimary: true },
      { name: "JWT", icon: SiJsonwebtokens, color: "#D63AFF", isPrimary: true },
      { name: "Burp Suite", icon: SiBurpsuite, color: "#FF6633" },
      { name: "Wireshark", icon: SiWireshark, color: "#1679A7" },
      { name: "Metasploit", icon: SiMetasploit, color: "#1369A1" },
      { name: "GitHub Copilot", icon: SiGithubcopilot, color: "#FFFFFF", isPrimary: true },
      { name: "Cursor", icon: VscCode, color: "#38BDF8", isPrimary: true },
    ],
  },
];
